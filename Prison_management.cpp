...
void Prison ::PrisonFile()
{
    ...
    case 1:
        ...
        MyFile_.open("Prison_Data.txt");//,ios::out,ios::in,ios::app

        MyFile_ << "\t\t\t\t    -----------------------------------------------------"<< endl;
        MyFile_ << "\t\t\t\t    |                                                   |"<< endl;
        MyFile_ << "\t\t\t\t    |                Prisoner list                      |"<< endl;
        MyFile_ << "\t\t\t\t    |                                                   |" << endl;
        MyFile_ << "\t\t\t\t    -----------------------------------------------------" << endl;
        ...
        MyFile_ << endl <<"=====================================================================================================================" << endl;
        MyFile_ << "SR.\tNAME\t\t\tCell Block\tAge\t\tGender\tHeight\tEye Colour\tCrime\tPunishment" << endl;
        MyFile_ << "=======================================================================================================================" << endl;
    ...
    case 2:
        ...
        cout << "\t\t\t\t    -----------------------------------------------------"<< endl;
        cout << "\t\t\t\t    |                                                   |"<< endl;
        cout << "\t\t\t\t    |          Word File created successfully           |"<< endl;
        cout << "\t\t\t\t    |                                                   |"<< endl;
        cout << "\t\t\t\t    -----------------------------------------------------"<< endl;

        MyFile_.open("Prison_Data.doc");//,ios::out,ios::in,ios::app
...
void Prison ::Afterlogin()
{
    ...
    do
    {
        ...
        cout << "\t\t\t\t|                     1)   New prisoner entry                             |"<< endl;
        cout << "\t\t\t\t|                                                                         |"<< endl;
        for (a = 0; a <= 100000000; a++)
        {
        }
        cout << "\t\t\t\t|                     2)   Prisoner details                               |"<< endl;
        cout << "\t\t\t\t|                                                                         |"<< endl;
        for (a = 0; a <= 100000000; a++)
        {
        }
        cout << "\t\t\t\t|                     3)   Attendance prisoner                            |"<< endl;
        cout << "\t\t\t\t|                                                                         |"<< endl;
        for (a = 0; a <= 100000000; a++)
        {
        }
